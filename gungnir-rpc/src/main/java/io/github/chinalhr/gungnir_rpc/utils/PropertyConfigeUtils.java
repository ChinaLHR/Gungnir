...
public class PropertyConfigeUtils {
    ...
    private static final String PROPERTY_CLASSPATH = "/gungnir_rpc.properties";
     ...
     * distributedlock
     */
    private static Long distributedLockTimeout;//分布式锁超时时间
    ...
    static {
        ...
        try {
            ...
            if (null==is){
                throw new IllegalArgumentException("gungnir_rpc.properties can not found in the classpath");
            }
            properties.load(is);
            ...
            distributedLockTimeout = Long.valueOf(properties.getProperty("distributedLockTimeout","5000"));

        }catch (Throwable t){
            LOGGER.error("load gungnir_rpc.properties failed",t);
    ...
    public static Long getDistributedLockTimeout() {
