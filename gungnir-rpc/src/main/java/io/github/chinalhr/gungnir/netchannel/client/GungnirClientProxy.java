...
public class GungnirClientProxy implements FactoryBean<Object>,InitializingBean {
    ...
    public Object getObject() throws Exception {
        ...
        return Proxy.newProxyInstance(iclass.getClassLoader(), new Class[]{iclass}, new InvocationHandler() {
            @Override
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                ...
                serviceDiscovery = new ZkServiceDiscovery(zkAddress,zkSession_TimeOut,zkConnection_TimeOut);
